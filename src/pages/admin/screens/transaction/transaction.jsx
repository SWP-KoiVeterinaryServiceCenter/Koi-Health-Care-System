...
const Transaction = (props) => {
  ...
  const accounts = useSelector(allTransactionSelector);
      ...
      .then((response) => {
        ...
        if (response.error) {
          ...
          Swal.fire(
            ...
            dispatch(getAllTransactionThunk()); // Reload data after success
          });
        }
      })
      .catch((error) => {
          ...
          <Container>
            ...
            >
              ...
              <Typography
                ...
                mt={1}
              >
                TRANSACTION management system, which allows admin to view
                their transactions.
              </Typography>
            </Grid>
          </Container>
