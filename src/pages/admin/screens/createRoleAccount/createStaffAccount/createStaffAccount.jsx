...
import { createStaffAccountThunk } from "../../../../../store/apiThunk/userThunk";
...
export default function CreateStaffAccount() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        await dispatch(createStaffAccountThunk(values)).unwrap();
        Swal.fire({
          title: SUCCESSTEXT,
  ...
  return (
    <div className="createPackage">
      <Header
        ...
        subtitle="Create an account for Staff to easily manage information"
      />
